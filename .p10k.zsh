# Generated by Powerlevel10k configuration wizard on 2022-05-15 at 12:52 +08.
...
() {
  ...
  # Git subsegment background colour
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='%255Ftook '
  # Execution time subsegment background colour
